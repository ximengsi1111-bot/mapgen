...
# ============================================================
# NPU inference
# Fixed recipe: phase_b | lane_given_intersection | DINOv2 | Qwen3 | no DeepStack
# ============================================================
...
TEST_JSON={TEST_JSON:-{DATASET_PATH}/phase_b/test.jsonl}
LOCAL_OUTPUT_ROOT={LOCAL_OUTPUT_ROOT:-{OBS_CACHE}/test_phase_b_lane_given_intersection}
CLOUD_OUTPUT_DIR={CLOUD_OUTPUT_DIR:-{OBS_CACHE}/test_results_phase_b_lane_given_intersection}
...
echo "[test] phase_b | lane_given_intersection | {VISION_RECIPE} | {MODEL_LABEL}"
