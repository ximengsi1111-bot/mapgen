...
# ============================================================
# NPU 推理评估
# 固定配方：phase_a | lane_given_intersection | dinov2 + CapRL-Qwen3VL-4B | 无 DeepStack
...
LOCAL_OUTPUT_ROOT=${LOCAL_OUTPUT_ROOT:-${OBS_CACHE}/results/test_phase_a_lane_given_intersection_dinov2_caprl4b_output_${RUN_ID}}  # 每次运行的本地推理输出根目录。
...
export RDZV_ID=${RDZV_ID:-test_phase_a_lane_given_intersection_caprl4b_${RUN_ID}}       # 本次分布式运行的唯一会合 ID。
